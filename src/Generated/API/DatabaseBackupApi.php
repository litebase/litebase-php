...
class DatabaseBackupApi
{
     ...
     */
    public function deleteDatabaseBackup($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['deleteDatabaseBackup'][0])
    {
        list($response) = $this->deleteDatabaseBackupWithHttpInfo($timestamp, $database_name, $branch_name, $contentType);
        return $response;
    }
     ...
     */
    public function deleteDatabaseBackupWithHttpInfo($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['deleteDatabaseBackup'][0])
    {
        $request = $this->deleteDatabaseBackupRequest($timestamp, $database_name, $branch_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDatabaseBackupAsync($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['deleteDatabaseBackup'][0])
    {
        return $this->deleteDatabaseBackupAsyncWithHttpInfo($timestamp, $database_name, $branch_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDatabaseBackupAsyncWithHttpInfo($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['deleteDatabaseBackup'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteDatabaseBackupRequest($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['deleteDatabaseBackup'][0])
    {
     ...
     */
    public function getDatabaseBackup($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['getDatabaseBackup'][0])
    {
        list($response) = $this->getDatabaseBackupWithHttpInfo($timestamp, $database_name, $branch_name, $contentType);
        return $response;
    }
     ...
     */
    public function getDatabaseBackupWithHttpInfo($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['getDatabaseBackup'][0])
    {
        $request = $this->getDatabaseBackupRequest($timestamp, $database_name, $branch_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDatabaseBackupAsync($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['getDatabaseBackup'][0])
    {
        return $this->getDatabaseBackupAsyncWithHttpInfo($timestamp, $database_name, $branch_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDatabaseBackupAsyncWithHttpInfo($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['getDatabaseBackup'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDatabaseBackupRequest($timestamp, $database_name, $branch_name, string $contentType = self::contentTypes['getDatabaseBackup'][0])
    {
