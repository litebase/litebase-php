...
class QueryApi
{
     ...
     * @param  \Litebase\Generated\Model\CreateQueryRequest $create_query_request Query creation data (required)
     ...
     * @return \Litebase\Generated\Model\CreateQuery200Response|\Litebase\Generated\Model\ErrorResponse|\Litebase\Generated\Model\ErrorResponse|\Litebase\Generated\Model\ValidationErrorResponse|\Litebase\Generated\Model\ErrorResponse
     */
     ...
     * @throws \Litebase\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Litebase\Generated\Model\CreateQuery200Response|\Litebase\Generated\Model\ErrorResponse|\Litebase\Generated\Model\ErrorResponse|\Litebase\Generated\Model\ValidationErrorResponse|\Litebase\Generated\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Litebase\Generated\Model\CreateQuery200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Litebase\Generated\Model\CreateQuery200Response';
        $request = $this->createQueryRequest($database_name, $branch_name, $create_query_request, $contentType);
    ...
    public function createQueryRequest($database_name, $branch_name, $create_query_request, string $contentType = self::contentTypes['createQuery'][0])
    {
        ...
        $resourcePath = '/v1/databases/{databaseName}/branches/{branchName}/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
