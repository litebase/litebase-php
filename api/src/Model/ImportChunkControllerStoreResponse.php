...
class ImportChunkControllerStoreResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportChunkControllerStoreResponse';
