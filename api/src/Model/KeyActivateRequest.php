...
class KeyActivateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyActivateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['encryptionKey'] === null) {
            $invalidProperties[] = "'encryptionKey' can't be null";
        }
